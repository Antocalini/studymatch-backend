...
import { getMe, setupUserProfile, updateSubjectsOfInterest, getUserCount } from '../controllers/user.controller.js'; // Note the .js extension
...
router.get('/count', getUserCount); // NEW: Route for user count
